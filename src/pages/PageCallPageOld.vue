...
export default {
	...
	methods: {
		reloadData(){
			...
			axios.post(`${process.env.SERVER_URL}/api/call-page/get-history`, {
		...
		newContact(){
			...
			axios.post(`${process.env.SERVER_URL}/api/call-page/new-contact`, {
				dataUser: dataUser,
		...
		sendCotnact(){
			...
			Loading.show({ spinner: QSpinnerGears })
			let dataUser = this.$store.state.app.appData.dataUser
			axios.post(`${process.env.SERVER_URL}/api/call-page/update-new`, {
				dataUser: dataUser,
				dataContact: {
		...
		saveChange(){
			...
			Loading.show({ spinner: QSpinnerGears })
			let dataUser = this.$store.state.app.appData.dataUser
			axios.post(`${process.env.SERVER_URL}/api/call-page/update`, {
				dataUser: dataUser,
				dataContact: {
